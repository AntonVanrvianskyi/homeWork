...
function arrayList(arr) {
    ...
    for (const { id, name, ...rest } of arr) {
        ...
        wrap.append(h1,ul1,renderList(rest));
...
function explorer(element,object) {
    ...
    for (let i = 0; i < element.childNodes.length; i++) {
        ...
        if (child.nodeName.match(/^H\d/)) {
            ...
            object.paragraphs.push(child.textContent.trim());
        }
        else if (child.nodeType === 1) {
            explorer(child, object);
        }
    }
}
let object = {
